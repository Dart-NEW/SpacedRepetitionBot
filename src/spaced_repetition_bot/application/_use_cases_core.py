"""Shared application use cases and supporting helpers.

The public `spaced_repetition_bot.application.use_cases` module re-exports the
symbols defined here. Keeping the shared helpers and non-quiz flows in a
separate module improves maintainability without changing the external API.
"""
